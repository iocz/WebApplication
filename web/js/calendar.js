...
document.write('<table id="fc" style="position:absolute;border-collapse:collapse;background:#FFFFFF;border:1px solid #f8f8f8;display:none;-moz-user-select:none;-khtml-user-select:none;user-select:none;" cellpadding="2">');
...
document.write('<tr style="background:#515151;font:12px Arial;color:#FFFFFF"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#e6e6fa" onclick="today()">Сегодня: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
...
function cs_over(e) {
    evtTgt(EvtObj(e)).style.background='#f1f1f1';
}
function cs_out(e) {
...
function f_cps(obj) {
    ...
    obj.style.border='1px solid #f0f0f0';//'1px solid #606060';
